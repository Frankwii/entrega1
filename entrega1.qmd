...
```
Observamos, entonces, que hay tres especies distintas de pingüinos. De más a menos común son *Adelie*, *Chisntrap* y *Gentoo*. De manera más visual, tenemos el siguiente gráfico:

```{r}
# habria que cambiar los colores
colores<-c("red", "green", "blue")

ggplot(penguins, aes(x=as.factor(species), fill=as.factor(species))) +
  geom_bar() +
...
- **Sexo**, cualitativa nominal dicotómica.
- **Año**, 
>>>>>>> f72ef4ca761635623c8dbdebecf36e411ec650f9
